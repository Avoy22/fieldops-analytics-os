...
Streamlit Community Cloud demo: **Coming soon**

After deployment, replace this placeholder with the live app URL:

```text
https://your-fieldops-analytics-os.streamlit.app/
```
...
After deployment, copy the live Streamlit URL into the **Live Demo** section of this README.
